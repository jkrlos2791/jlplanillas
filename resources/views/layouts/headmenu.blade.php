<div class="row  ">
        ...
        @endif
            ...
            <ul class="nav navbar-top-links navbar-right">
				<li class=" "><b> {{ Session::get('empresa') }} <small>{{ Session::get('mes') }} {{ Session::get('anio') }}</small></b></li>
...
@if(Auth::user()->group_id == 1)
		...
		<li class="user dropdown">
			...
			<a class="dropdown-toggle" href="javascript:void(0)" title="{{ Lang::get('core.m_controlpanel') }}"  data-toggle="dropdown"><i class="icon-cog2"></i> <i class="caret"></i></a>
